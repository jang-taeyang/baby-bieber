/**
 * The problem of searching for the word "I":
 * Searching for the word "I" in the lyrics is challenging because "I" is a common pronoun,
 * often used in contractions (e.g., "I'll", "I'm") or within other words.
 * A simple `.includes("I")` check may return incorrect results if it matches parts of
 * other words instead of the standalone word "I".
 * To accurately count occurrences, we might use word boundaries (`\bI\b` in regex).
 */

export const bieberBaby: string[] = [
